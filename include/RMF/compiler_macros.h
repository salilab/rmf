...
#define RMF_COMPILER_WARNINGS                                                                                                      \
  ...
  RMF_CLANG_PRAGMA(diagnostic warning "-Wabi")                                                                                     \
      ...
      RMF_CLANG_PRAGMA(diagnostic warning "-Wcomment") RMF_CLANG_PRAGMA(                                                           \
      ...
      RMF_CLANG_PRAGMA(diagnostic warning                                                                                          \
                       "-Wnon-virtual-dtor") /*RMF_CLANG_PRAGMA( diagnostic                                                        \
      ...
      RMF_CLANG_PRAGMA(diagnostic warning "-Wswitch-default") /* This is just a dumb warning, provided for gcc \
                              compat.*/ RMF_CLANG_PRAGMA( \
          diagnostic ignored "-Wswitch-enum")                                                                                      \
      ...
      RMF_CLANG_PRAGMA(diagnostic warning                                                                                          \
                       "-Wunused") /* This is getting triggered with swig for                                                      \
                               some reason */                                                                                      \
      ...
      RMF_CLANG_PRAGMA(diagnostic warning "-Wwrite-strings") /* Most of these are stupid uses of floats        \
                                instead of doubles. I don't                    \
                                want to fix them all now. For some reason this \
                                needs to be last.*/ RMF_CLANG_PRAGMA( \
