...
#define RMF_COMPILER_WARNINGS                                                  \
  ...
  RMF_CLANG_PRAGMA(diagnostic warning "-Wabi")                                 \
      ...
      RMF_CLANG_PRAGMA(                                                        \
          diagnostic warning                                                   \
          "-Wswitch-default") /* This is just a dumb warning, provided for gcc \
                              compat.*/ RMF_CLANG_PRAGMA(diagnostic ignored    \
                                                         "-Wswitch-enum")      \
...
/*ret+=["-Wno-deprecated",
  ...
  -fno-operator-names",]*/
#if __GNUC__ > 4 || __GNUC_MINOR__ >= 6
#define RMF_GCC_CXX0X_COMPAT RMF_GCC_PRAGMA(diagnostic ignored "-Wc++0x-compa" \
                                                               "t")
...
#define RMF_COMPILER_WARNINGS                                   \
  RMF_GCC_PRAGMA(diagnostic warning "-Wall")                    \
      ...
      RMF_GCC_PROTOTYPES RMF_GCC_CXX0X_COMPAT
