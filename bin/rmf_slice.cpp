...
int main(int argc, char** argv) {
  try {
    ...
    RMF_ADD_FRAMES;
    bool silent=false;
    options.add_options()("invisible,v",
                          boost::program_options::bool_switch(&silent),
    ...
    if(!silent) std::cout << "Copying frames";
    ...
    if(!silent) std::cout << num_copied << " frames copied" << std::endl;
    return 0;
  }
