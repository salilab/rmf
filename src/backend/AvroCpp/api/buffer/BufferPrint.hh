...
#ifndef rmf_avro_BufferPrint_hh__
#define rmf_avro_BufferPrint_hh__
...
inline std::ostream &operator<<(std::ostream &os,
                                const rmf_avro::OutputBuffer &buffer) {
  rmf_avro::BufferReader reader(buffer);
  rmf_avro::detail::hexPrint(os, reader);
  return os;
}

inline std::ostream &operator<<(std::ostream &os,
                                const rmf_avro::InputBuffer &buffer) {
  rmf_avro::BufferReader reader(buffer);
  rmf_avro::detail::hexPrint(os, reader);
  return os;
}
