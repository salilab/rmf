...
using rmf_avro::OutputStream;
using rmf_avro::InputStream;
using rmf_avro::Encoder;
using rmf_avro::Decoder;
using rmf_avro::EncoderPtr;
using rmf_avro::DecoderPtr;
using rmf_avro::memoryInputStream;
using rmf_avro::memoryOutputStream;
using rmf_avro::binaryEncoder;
using rmf_avro::validatingEncoder;
using rmf_avro::binaryDecoder;
using rmf_avro::validatingDecoder;
