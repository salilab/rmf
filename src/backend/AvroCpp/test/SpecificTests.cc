...
boost::unit_test::test_suite *init_unit_test_suite(int argc, char *argv[]) {
  ...
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testBool));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testInt));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testLong));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testFloat));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testDouble));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testString));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testBytes));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testFixed));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testArray));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testMap));
  ts->add(BOOST_TEST_CASE(rmf_avro::specific::testCustom));
  return ts;
}
