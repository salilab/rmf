...
#ifndef rmf_avro_json_JsonIO_hh__
#define rmf_avro_json_JsonIO_hh__
...
class AVRO_DECL JsonGenerator {
 ...
 public:
  ...
  void encodeNumber(double t) { encodeFloatingPointNumber<double>(t); }

  void encodeNumber(float t) { encodeFloatingPointNumber<float>(t); }
