 ...
 */
  ...
  inline String get_node_data_data_set_name() { return "node_data"; }
  //! Get the name of the data set storing the name for each node
  inline String get_node_name_data_set_name() { return "node_name"; }
  //! Get the name of the data set storing the data about each frame
  inline String get_frame_name_data_set_name() { return "frame_name"; }
  //! Get the name of the data set for storing bonds
  inline String get_bond_data_data_set_name() { return "bond_data"; }
  //! Get the name of the data set for storing bonds
