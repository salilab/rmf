...
template<> struct codec_traits<rmf_raw_avro2::_Frame_json_Union__0__> {
    ...
    static void decode(Decoder& d, rmf_raw_avro2::_Frame_json_Union__0__& v) {
        ...
        if (n >= 2) { throw internal_avro::Exception("Union index too big"); }
        switch (n) {
        case 0:
            {
...
template<> struct codec_traits<rmf_raw_avro2::Vector4sValue> {
...
template<> struct codec_traits<rmf_raw_avro2::Vector4sNodeData> {
