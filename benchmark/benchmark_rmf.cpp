...
double show_type_data_xml(RMF::NodeConstHandle nh, RMF::Category kc) {
  double ret = 0;
...
double show_data_xml(RMF::NodeConstHandle nh, RMF::Category kc) {
  double ret = 0;
...
double show_xml(RMF::NodeConstHandle nh, const RMF::Categories& kcs) {
  double ret = 0;
