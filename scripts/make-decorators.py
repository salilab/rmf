...
make_header("physics", [static_particle, particle, static_iparticle, iparticle, pparticle, diffuser,
...
score= Decorator(["FEATURE"], "feature",
                 ...
                 [Children("representation", "The various components of this score node.", True),
...
static_colored= Decorator(["REPRESENTATION", "ORGANIZATIONAL", "ALIAS", "FEATURE", "GEOMETRY"],
                   "shape",
...
static_geometry_coordinates = Attributes("coordinates", "Floats", ["cartesian xs",
                                                          "cartesian ys",
                                                          "cartesian zs"],
                                   "Coordinates of the center in angstroms.", True)
geometry_index = Attribute("type", "Index", "The type of the geometric object.", True)
...
make_header("shape", [colored, ball, cylinder, segment, static_colored, static_ball, static_cylinder, static_segment], [])
...
journal= Decorator(["ORGANIZATIONAL"], "publication",
                   ...
                   [Attribute("title", "String", "The article title.", True),
                    Attribute("journal", "String", "The journal title.", True),
